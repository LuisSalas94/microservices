...
public class LoansController {
    ...
    @Operation(
            ...
            description = "REST API to create new loan inside FernandoBank"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
